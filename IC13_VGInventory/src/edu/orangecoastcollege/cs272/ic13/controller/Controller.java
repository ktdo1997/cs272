...
public class Controller
{
    ...
    // Below is the relationship table "user_games" which associates users with
    // the video games in their inventory
    ...
    public static Controller getInstance()
    {
        if (theOne == null)
        {
            ...
            try
            {
                ...
                // Create the video game table in the database, loading games
                // from the CSV file
    ...
    public ObservableList<VideoGame> getGamesForCurrentUser()
    {
        ...
        // TODO: Implement this method
        // 1) With the user_games table (mUserGamesDB), get the records that
        // match the current user's (mCurrentUser) id
        try
        {
        ...
        // Note: the records returned will only contain the user_id and game_id
        // (both ints)
        // Loop through the all games list (mAllGamesList). If any game in the
        // list matches the game id, then:
    ...
    {
        // TODO: Implement this method
        // 1) Create an ObservableList<VideoGame> assigned to the list returned
        ObservableList<VideoGame> gamesOwnedByCurrentUser = getGamesForCurrentUser();
        // from getGamesForCurrentUser
        // If this list contains the selected game, return false (game has
        // already been added, so prevent duplicates)
        if (gamesOwnedByCurrentUser.contains(selectedGame)) 
            return false;

        // 2) Create a String array of the values to insert into the user_games
        // (mUserGamesDB) table.
        // There are only two values in this table: the user's id (mCurrentUser)
        // and the selected game id
        ...
        // 3) Create a new record using the USER_GAMES_FIELD_NAMES and the
        // values array
